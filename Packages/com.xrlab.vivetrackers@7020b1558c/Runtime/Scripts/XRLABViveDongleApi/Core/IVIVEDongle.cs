...
namespace VIVE_Trackers
{
    ...
    public interface IVIVEDongle : IDisposable
    {
        ...
        /// </summary>
        /// <param name="currentDeviceIndex"></param>
        void ReMap(int currentDeviceIndex);
        void RequestDeviceInfoFromTracker(int currentDeviceIndex);
        ...
        /// <param name="ack_command"></param>
        void SendAck(int trackerIndex, string ack_command);
    }
}
